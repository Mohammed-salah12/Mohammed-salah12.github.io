...
export const practicesQuestions = [
  { id: 'practice_1', label: 'أتجنب التعرض المباشر للشمس بعد جلسات الليزر.' },
...
export const attitudesQuestions = [
  ...
  { id: 'attitude_5', label: 'أجهزة الليزر المنزلية آمنة للاستخدام العام.' },
  {
    id: 'attitude_6',
    label: 'تُعد وسائل التواصل الاجتماعي مصدرًا موثوقًا للمعلومات المتعلقة بالليزر التجميلي.',
  },
  {
    id: 'attitude_7',
    label: 'تشكل تكلفة جلسات الليزر عائقًا أمام الكثير من الأشخاص.',
  },
  {
    id: 'attitude_8',
...
export const riskQuestions = [
  {
    id: 'risk_1',
    label: 'قد تسبب إجراءات الليزر مضاعفات جلدية طويلة الأمد إذا أُجريت بشكل غير صحيح.',
  },
  {
    id: 'risk_2',
